    ...
    <style type="text/css">
        ...
        */
        #templateHeader{
            ...
            /*@editable*/padding-top:46px;
            /*@editable*/padding-bottom:46px;
        }
        /*
        @tab Header
                                                    ...
                                                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                        <tbody><tr>
                                                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                ...
                                                                <img align="center" alt="" src="https://gallery.mailchimp.com/611777e93e2c8806e2d53dda8/images/543c08c4-1209-4843-9ee0-5b0d5a342a93.png" width="564" style="max-width:1024px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                        ...
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <p><strong>Meno: </strong>{{ .Name }} {{ .Surname }}<br>
                                                                    ...
                                                                    <strong>Zdravotné obmedzenia: </strong>{{ .Restrictions }}<br><br>
                                                                    <strong>Podujatie:</strong> {{ .EventName }}<br>
                                                                    {{ range .Days }}
                                                                    {{ . }} <br>
                                                                    {{ end }}
                                                            </td>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <h1 style="text-align: left;"><span style="font-size:24px">Doplňujúce informácie</span></h1>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <h1 style="text-align: left;"><span style="font-size:20px">Covid-19</span></h1>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <p>
                                                                    Situáciu ohľadom pandémie pozorne sledujeme a reagujeme na usmernenia ÚVZSR. Ako organizátori si vyhradzujeme právo na zmenu programu kvôli COVID 19 alebo na zrušenie celej akcie v prípade zhoršenia epidemiologickej situácie. Samozrejme, o všetkých zmenách vás budeme včas informovať a peniaze vám vrátime. Odporúčame vám sledovať naše sociálne siete. (FB: Saleziáni Banská Bystrica- Salezko)
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        </tbody></table>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <h1 style="text-align: left;"><span style="font-size:24px">Kontakt</span></h1>
                                                                                                                ...
                                                                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                                                                    <tbody><tr>
                                                                                                                        ...
                                                                                                                        <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                                                            <a href="http://www.facebook.com/salezianibb/" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/outline-light-facebook-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                                                        </td>
